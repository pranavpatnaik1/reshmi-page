...
import portCreditImage from './assets/events/portcredit.jpg';
      ...
      <div className="products-section">
        ...
        <div className="events-section">
          <div className="events-container">
            <h2 className="section-title"><i><u>UPCOMING EVENTS</u></i></h2>
            <div className="event-card">
              <img 
                src={portCreditImage} 
                alt="Port Credit Event Location" 
                className="event-image"
              />
              <div className="event-details">
                <div className="event-detail">
                  <i className="far fa-calendar"></i>
                  <span>Date: Saturday, June 14th, 2025</span>
                </div>
                <div className="event-detail">
                  <i className="far fa-clock"></i>
                  <span>Event Time: 10:00 AM – 2:00 PM</span>
                </div>
                <div className="event-detail">
                  <i className="fas fa-map-marker-alt"></i>
                  <span>Location: 35 Front Street North, Mississauga (Port Credit)</span>
                </div>
              </div>
            </div>
          </div>
